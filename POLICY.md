...
- 2026-07-17 — Privacy Policy published (PRIVACY.md, rendered on both
  sites) and joined to consent by the agreement line under the begin
  button ("By clicking BEGIN MY FIRST TESTIMONY you agree to the
  Privacy Policy"). Two affirmations retired as redundant with the
  consent page's own Permanence section (published testimonies
  cannot be edited; part of humanity's permanent record). The oath
  is now five affirmations; the site and desk enforce five.

- 2026-07-17 — Vocabulary: in living text the institution is now
  called "The Record" (capital The), the natural short form of The
  Human Record; "the Archive" retires. A human's entry stays "a
  record," lowercase, and what a human writes is "a testimony": a
  record holds at most three testimonies (NAMING.md, The words we
  use).
